                    ...
                    isSolicitudes ? (
                        <div className={style.permission_formularycontainer}>
                            ...
                            <div className={style.formulary_upperinformationcontainer}>
                                ...
                                <div className={style.previewcard} onClick={absencef_parameter != undefined ?() => setShowPopup(true): null} style={absencef_parameter == undefined ? {backgroundColor:'var(--primary-disabled)', cursor: 'default'}:{}}><Image src={"/Search.svg"} width={20} height={20} alt='magnifying-glass-icon' className={style.searchicon}></Image></div>
                            </div>
...
function SendPopup({ PPabsencef_parameter, setShowPopup, PPuserInfo_parameter, PPtitle_parameter, PPposition_parameter}){
    const reasons = ["", "Cita médica", "Convocatoria Asamblea", "Asuntos Personales"]
    return(
...
function JSendPopup({setJShowPopup, PPjustificationf_parameter, PPJposition_parameter, PPJtitle_parameter, PPJuserInfo_parameter}){
    const reasons = ["", "Cita médica", "Convocatoria Asamblea", "Asuntos Personales"]
    return(
        <div className={style.popUpContainer}>
            ...
            <div className={style.popUpCard}>
                ...
                <div className={style.form_container}>
                    ...
                    <form className={style.form}>
                        ...
                        <div className={style.reasoncontainer2}>
                            <span>Motivo:</span>
                            <select name="reasons" id="reasons" disabled>
